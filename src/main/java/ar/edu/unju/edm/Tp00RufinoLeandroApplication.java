...
public class Tp00RufinoLeandroApplication {

	public static void main(String[] args) {
		SpringApplication.run(Tp00RufinoLeandroApplication.class, args);
		String nombre = " Leandro";
		System.out.println("Rufino" + nombre + name2());

		Estudiante estudiante = new Estudiante();
		estudiante.setDni("50.000.000");
		estudiante.setName("Rufino");

		System.out.println("El estudiante " + estudiante.getName() + " dice hola!");
